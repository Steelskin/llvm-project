...
macro(add_clang_library name)
  ...
  # (see LLVM_PCH_ABI_TAG there) won't let it reuse an LLVM provider's PCH that
  # was compiled without the clang ABI define this target carries -- clang-cl
  # otherwise warns -Wclang-cl-pch on the predefines mismatch even though the
  # LLVM PCH content never references CLANG_ABI. Windows-only and mirrors the
  # CLANG_BUILD_STATIC / CLANG_EXPORTS conditions just below.
