...
/// line of any tool that also links the static component directly (duplicate
/// symbol under lld-link; link.exe silently picks one).
///
...
/// in the same object, a static library, or an import library. `CLANG_ABI_EXPORT`
/// satisfies this (it is empty under `CLANG_BUILD_STATIC`).
