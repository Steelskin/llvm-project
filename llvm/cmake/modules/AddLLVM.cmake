...
function(llvm_add_library name)
  cmake_parse_arguments(ARG
    "MODULE;SHARED;STATIC;OBJECT;DISABLE_LLVM_LINK_LLVM_DYLIB;IN_LLVM;SONAME;NO_INSTALL_RPATH;COMPONENT_LIB;DISABLE_PCH_REUSE"
  ...
  if(ARG_IN_LLVM AND (ARG_COMPONENT_LIB OR ARG_DISABLE_LLVM_LINK_LLVM_DYLIB))
    message(FATAL_ERROR "${name}: IN_LLVM cannot be combined with "
  ...
  if(ARG_COMPONENT_LIB OR ARG_IN_LLVM)
...
function(add_llvm_pass_plugin name)
  ...
  if(LLVM_${name_upper}_LINK_INTO_TOOLS)
      if(ARG_NO_MODULE)
        list(APPEND ARG_UNPARSED_ARGUMENTS IN_LLVM)
      else()
